...
sr.reveal(`.goal__card, .years__swiper, .experience__hero_img, .experience__number_container, .experience__card, .talk__environment_image, .lifestyle__image_wrapper, .upscaling__hero, .individual__hero_data, .individual__company_ranking`)
...
sr.reveal(`.card__wrapper, .partner__img_wrapper, .experience__gallery_image, .step__card, .upscaling__project_card, .ranking__advantage_card, .simple__impact_card`, { interval: 300, distance: "100px" });
